  ...
  <body>
    ...
    <!--Jumbotron with Sign up Button -->
      <div class="jumbotron" id="myContainer">
          ...
          <button type="button" class="btn btn-lg green signup" data-target="#sigmupModal" data-toggle="modal">Sing up-It's free</button>
    ...
    <!--Sign up form -->
      <form method="post" id="signupform">
          <div class="modal" id="sigmupModal" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="model-header">
                        <button class="close" data-dismiss="modal">&times;</button>
                    ...
                    <div class="model-body">
                       ...
                       <div class="form-group">
                        ...
                        <input class="form-control" type="password" name="password2" id="password2" placeholder="Confiram a password" maxlength="30"> 
                       </div>
