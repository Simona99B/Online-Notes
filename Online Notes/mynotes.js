    ...
    //load notes on page load: Ajax call to loadnotes.php
        ...
        $("textarea").keyup(function(){
            ...
            $.ajax({
               url: "updatenote.php",
               type: "POST",
               //we need to send the current note content with its id to the php file znaci ova data ne e isto so ona of function(data) od success toa e bilo so sho se vrakja
        ...
        //function
                ...
                $(".delete").click(function(){
                   ...
                   //send ajax call to delete note
                     $.ajax({
                       url: "deletenote.php",
                       type: "POST",
                       //we need to send the current note to be deleted
            ...
            //show Hide function      
                //aray1 site id na elementi so sakamo da gi pokazemo, array2 id na site elementi so sakamo da gi skriemo
